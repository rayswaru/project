...
{
  new (message_memory) bumperbot_msgs::srv::AddTwoints_Request(_init);
}

void AddTwoints_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<bumperbot_msgs::srv::AddTwoints_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AddTwoints_Request_message_member_array[2] = {
  {
    ...
    offsetof(bumperbot_msgs::srv::AddTwoints_Request, a),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(bumperbot_msgs::srv::AddTwoints_Request, b),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AddTwoints_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(bumperbot_msgs::srv::AddTwoints_Request),
...
{
  return &::bumperbot_msgs::srv::rosidl_typesupport_introspection_cpp::AddTwoints_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bumperbot_msgs, srv, AddTwoints_Request)() {
  return &::bumperbot_msgs::srv::rosidl_typesupport_introspection_cpp::AddTwoints_Request_message_type_support_handle;
}
...
void AddTwoints_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) bumperbot_msgs::srv::AddTwoints_Response(_init);
}

void AddTwoints_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<bumperbot_msgs::srv::AddTwoints_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AddTwoints_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(bumperbot_msgs::srv::AddTwoints_Response, sum),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AddTwoints_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(bumperbot_msgs::srv::AddTwoints_Response),
...
{
  return &::bumperbot_msgs::srv::rosidl_typesupport_introspection_cpp::AddTwoints_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bumperbot_msgs, srv, AddTwoints_Response)() {
  return &::bumperbot_msgs::srv::rosidl_typesupport_introspection_cpp::AddTwoints_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers AddTwoints_service_members = {
  ...
  // see get_service_type_support_handle<bumperbot_msgs::srv::AddTwoints>()
...
get_service_type_support_handle<bumperbot_msgs::srv::AddTwoints>()
{
  ...
  auto service_type_support =
    &::bumperbot_msgs::srv::rosidl_typesupport_introspection_cpp::AddTwoints_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, bumperbot_msgs, srv, AddTwoints)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<bumperbot_msgs::srv::AddTwoints>();
}
