...
bool bumperbot_msgs__srv__add_twoints__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("bumperbot_msgs.srv._add_twoints.AddTwoints_Request", full_classname_dest, 50) == 0);
  }
...
PyObject * bumperbot_msgs__srv__add_twoints__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("bumperbot_msgs.srv._add_twoints");
...
ROSIDL_GENERATOR_C_EXPORT
bool bumperbot_msgs__srv__add_twoints__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("bumperbot_msgs.srv._add_twoints.AddTwoints_Response", full_classname_dest, 51) == 0);
  }
