...
#include <stddef.h>
#include "bumperbot_msgs/srv/detail/add_twoints__rosidl_typesupport_introspection_c.h"
#include "bumperbot_msgs/msg/rosidl_typesupport_introspection_c__visibility_control.h"
#include "rosidl_typesupport_introspection_c/field_types.h"
#include "rosidl_typesupport_introspection_c/identifier.h"
#include "rosidl_typesupport_introspection_c/message_introspection.h"
#include "bumperbot_msgs/srv/detail/add_twoints__functions.h"
#include "bumperbot_msgs/srv/detail/add_twoints__struct.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers bumperbot_msgs__srv__detail__add_twoints__rosidl_typesupport_introspection_c__AddTwoints_service_members = {
  "bumperbot_msgs__srv",  // service namespace
  "AddTwoints",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // bumperbot_msgs__srv__detail__add_twoints__rosidl_typesupport_introspection_c__AddTwoints_Request_message_type_support_handle,
  NULL  // response message
  // bumperbot_msgs__srv__detail__add_twoints__rosidl_typesupport_introspection_c__AddTwoints_Response_message_type_support_handle
};

static rosidl_service_type_support_t bumperbot_msgs__srv__detail__add_twoints__rosidl_typesupport_introspection_c__AddTwoints_service_type_support_handle = {
  0,
  &bumperbot_msgs__srv__detail__add_twoints__rosidl_typesupport_introspection_c__AddTwoints_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bumperbot_msgs, srv, AddTwoints)() {
  if (!bumperbot_msgs__srv__detail__add_twoints__rosidl_typesupport_introspection_c__AddTwoints_service_type_support_handle.typesupport_identifier) {
    bumperbot_msgs__srv__detail__add_twoints__rosidl_typesupport_introspection_c__AddTwoints_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)bumperbot_msgs__srv__detail__add_twoints__rosidl_typesupport_introspection_c__AddTwoints_service_type_support_handle.data;
  ...
  return &bumperbot_msgs__srv__detail__add_twoints__rosidl_typesupport_introspection_c__AddTwoints_service_type_support_handle;
}
